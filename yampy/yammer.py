...
from apis import MessagesAPI, UsersAPI, RealtimeAPI
...
class Yammer(object):
	...
	def realtime(self):
		"""
		Returns a :class:`yampy.apis.RealtimeAPI` object which can be used to call
		the Yammer API's realtime-related endpoints.
		"""
		if not hasattr(self, "_realtime_api"):
			self._realtime_api = RealtimeAPI(client=self._client)
		return self._realtime_api
